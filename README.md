...
Layout racine (app/_layout.tsx) : Stack Navigator
Onglets (app/(tabs)/_layout.tsx) : Tabs Navigator
Onboarding (app/onboarding/_layout.tsx) : Stack sequentiel
Story (app/story/_layout.tsx) : Stack avec Comic Viewer
Comic Viewer V1
...
expo-print : Genere le PDF a partir de HTML/CSS
expo-file-system : Renomme le fichier avec le titre de l'histoire
expo-sharing : Ouvre le dialogue de partage natif
Message de partage
...
Fonctionnalites implementees
 Onboarding complet (Hero, Avatar)
 Selection univers dynamique (Supabase)
 Selection debut histoire dynamique (Supabase)
 Comic Viewer V1 (PagerView + ComicPage)
 Export PDF avec nom de fichier personnalise
 Systeme d'etoiles (economie narrative)
 Bibliotheque d'histoires persistante
 Header overlay transparent
 Numerotation des pages dans le PDF
 Message de partage magique
